    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                <!-- Example single card, replace static values as needed -->
                <div class="product-card bg-white rounded-lg shadow-sm overflow-hidden relative">
                    <div class="relative">
                        <img src="https://via.placeholder.com/400x256" alt="Titre de l'annonce" class="w-full h-64 object-cover object-top">
                        <span class="badge bg-green-100 text-green-800 absolute top-3 right-3">Nouveau</span>
                    ...
                    <div class="p-4">
                        <div class="flex justify-between items-start mb-2">
                            <h3 class="font-semibold text-lg">Titre de l'annonce</h3>
                            <span class="text-secondary font-bold">1 000 DH</span>
                        </div>
                        <p class="text-gray-600 text-sm mb-3">Courte description de l'annonce ici.</p>
                        <div class="flex justify-between items-center">
                            <span class="text-xs text-gray-500">Casablanca • Aujourd'hui</span>
                            <span class="bg-gray-100 text-gray-700 text-xs px-2 py-1 rounded">Catégorie</span>
                        </div>
                    </div>
                </div>
            </div>
